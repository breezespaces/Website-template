...
import Pic1 from "../../../assets/CustomRichSuits/LFW_custom_rich_suits.jpeg";
...
const ProductPage: React.FC = () => {
  ...
  // default price if size not chosen
  const displayPrice = selectedSize ? sizePrices[selectedSize] : 150000;

  const bagItem: CartItem = {
    name: "LFW Custom Rich Suits",
    price: displayPrice,
    imageUrl: Pic1.src,
    quantity: 1,
    color: selectedColor,
    size: selectedSize, // ✅ matches CartItem type
  };
              ...
              <div className="grid grid-cols-5 gap-2">
                {sizeOptions.map((size) => (
                  <button
                    ...
                    className={`border py-2 flex flex-col items-center justify-center text-xs transition
                    ${
                      selectedSize === size
                  ...
                  >
                    ...
                    <span className="text-[12px] font-semibold">
                      ₦{(sizePrices[size] / 1000).toFixed(0)}k
                    </span>
                  </button>
                ))}
              </div>
